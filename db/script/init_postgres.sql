...
CREATE TABLE public.kms (
                ...
                chart_end_time TIME,
                max_deliveries INTEGER DEFAULT 0,
...
CREATE TABLE public.parking_restrictions (
                ...
                km_id BIGINT NOT NULL,
                parking_restriction_type VARCHAR(1) NOT NULL,
                street_id BIGINT NOT NULL,
...
CREATE TABLE public.shops (
                ...
                has_loading_area INTEGER DEFAULT 0,
                loading_area_type INTEGER,
                notes TEXT,
                lat DOUBLE PRECISION,
                lng DOUBLE PRECISION,
                created_at TIMESTAMP NOT NULL,
...
CREATE TABLE public.deliveries (
                ...
                distance_to_shop DOUBLE PRECISION,
                is_out_of_segment INTEGER,
                shops_served INTEGER,
                notes TEXT,
                lat DOUBLE PRECISION,
                lng DOUBLE PRECISION,
                created_at TIMESTAMP NOT NULL,
